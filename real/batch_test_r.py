...
def parse_args():
    ...
    # parser.add_argument('--set_names', default=['CBSD68', 'Kodak24', 'McMaster'], help='directory of test dataset')
    parser.add_argument('--set_names', default=['RealTest'], help='directory of test dataset')
    parser.add_argument('--sigma', default=25, type=int, help='noise level')
    parser.add_argument('--model_dir', default=os.path.join('models', 'rddcnn_real_sigma25'), help='directory of the model')
    parser.add_argument('--model_name', default='model_165.pth', type=str, help='the model name')
    ...
    for i in range(1):
        ...
        with torch.no_grad():
            ...
            for set_cur in args.set_names:
                ...
                ans.append(psnr_avg)
            # print(psnrs)
            utils.log('Datset: {0:10s} \n  PSNR = {1:2.3f}dB'.format(set_cur, psnr_avg))
