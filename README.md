# RDDCNN 
## A robust deformed CNN for image denoising(RDDCNN) by Qi Zhang, Jingyu Xiao, Chunwei Tian*, Jerry Chun-Wei Lin and Shichao Zhang is accepted by CAAI Transactions on Intelligence Technology, 2022 and it is implemented by PyTorch.
