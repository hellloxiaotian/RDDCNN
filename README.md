# RDDCNN 
## A robust deformed CNN for image denoising(RDDCNN) is proposed by  Qi Zhang, Jingyu Xiao, Chunwei Tian*, Jerry Chun-Wei Lin and Shichao Zhang. Also, it is accepted by the CAAI Transactions on Intelligence Technology, 2022 and it is implemented by PyTorch.
